...
describe("jinqJS TypeScript Definition Suite", function () {
  ...
  var people3 = [{
    Name: "Frank", Age: 1, Location: "Melville", Sex: SexEnum.Male 
  }];
  var people4 = [{
    Name: "Frank", Age: 67, Location: "Melville", Sex: SexEnum.Male 
  }];
  var sexType = [{
    Sex: SexEnum.Male, Location: "Islip", Title: "Its a boy!" 
  },
    {
